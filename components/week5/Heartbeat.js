...
export default function Bmi() {
  ...
  return (
    ...
    <View>
      ...
      >
        <Text style={{ fontSize: 18, marginTop: 10 }}>Weight (kg.)</Text>
        <TextInput
      ...
      >
        <Text style={{ fontSize: 18, marginTop: 10 }}>Height (cm.)</Text>
        <TextInput
          style={{ fontSize: 18, marginTop: 10 }}
      ...
      <TouchableOpacity onPress={onPressButton}>
        <View
          style={{ padding: 10, backgroundColor: "blue", borderRadius: 40 }}
        >
