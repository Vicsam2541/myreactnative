...
export default function Section2() {
  return (
    <View style={{ flexDirection:'column',alignItems:'center',marginTop :-35 ,marginLeft:25,marginRight:25, padding: 10, borderColor:"#AFEEEE" ,borderWidth : 1 ,borderRadius:20 ,backgroundColor:"#AFEEEE"}}>
